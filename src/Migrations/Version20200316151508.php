 ...
 */
final class Version20200316151508 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE icon (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, rank_id INT NOT NULL, nickname VARCHAR(30) NOT NULL, slug VARCHAR(30) NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, avatar VARCHAR(50) DEFAULT NULL, firstname VARCHAR(50) DEFAULT NULL, birthday DATE DEFAULT NULL, bio LONGTEXT DEFAULT NULL, status SMALLINT NOT NULL, experience INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D649A188FE64 (nickname), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649D60322AC (role_id), INDEX IDX_8D93D6497616678F (rank_id), INDEX idx_nickname (nickname), INDEX idx_slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE celestial_body (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, icon_id INT NOT NULL, name VARCHAR(50) NOT NULL, slug VARCHAR(50) NOT NULL, xPosition INT DEFAULT NULL, yPosition INT DEFAULT NULL, picture VARCHAR(50) DEFAULT NULL, nb_stars INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_53CDB29DA76ED395 (user_id), INDEX IDX_53CDB29D54B9D732 (icon_id), INDEX idx_name (name), INDEX idx_slug (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rank (id INT AUTO_INCREMENT NOT NULL, rank_number SMALLINT NOT NULL, name VARCHAR(30) NOT NULL, badge VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8879E8E51803F4E2 (rank_number), UNIQUE INDEX UNIQ_8879E8E55E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
